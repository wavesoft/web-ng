...
public class Tabs extends javax.swing.JPanel implements MouseListener, MouseMotionListener, ComponentListener {
    ...
    public static class Tab {
        ...
        public Tab(String title, String key, Image img, Component cmp) {
            ...
            this.anchorX = 0;
            this.width = 0;
            this.tabClose = new ImageButton(cmp, x, 0, new javax.swing.ImageIcon(getClass().getResource("/com/wavesoft/webng/resources/btn-close.png")));
    ...
    public Tabs() {
        ...
        newTabButton = new ImageButton(this, 0, 0, new javax.swing.ImageIcon(getClass().getResource("/com/wavesoft/webng/resources/btn-newtab.png")));
