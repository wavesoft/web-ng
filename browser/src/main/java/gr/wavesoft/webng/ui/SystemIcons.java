...
public class SystemIcons {
    ...
    static {
        ...
        Image im = null;
        try {
            im = ImageIO.read(SystemIcons.class.getResource("/gr/wavesoft/webng/resources/page-icon.png"));
        ...
        im = null;
        try {
            im = ImageIO.read(SystemIcons.class.getResource("/gr/wavesoft/webng/resources/error-icon.png"));
        } catch (IOException ex) {
        }
        tabIconError = im;
        ...
        im = null;
        try {
            im = ImageIO.read(SystemIcons.class.getResource("/gr/wavesoft/webng/resources/console-icon.png"));
        } catch (IOException ex) {
        }
        tabIconConsole = im;
        ...
        iconInfo =      new javax.swing.ImageIcon(SystemIcons.class.getResource("/gr/wavesoft/webng/resources/icons/info.png"));
        iconDebug =     new javax.swing.ImageIcon(SystemIcons.class.getResource("/gr/wavesoft/webng/resources/icons/debug.png"));
