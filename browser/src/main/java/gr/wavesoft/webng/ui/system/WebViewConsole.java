...
import gr.wavesoft.webng.io.SystemConsoleListener;
...
public class WebViewConsole extends WebViewNG implements SystemConsoleListener, HierarchyListener {
    ...
    public void webngSetBrowserWindow(BrowserWindow window) {
        ...
        window.setHeadButtons(new HeadButton[] { 
            ...
            @Override
            public Icon getIcon() {
                return new javax.swing.ImageIcon(getClass().getResource("/gr/wavesoft/webng/resources/delete.png"));
            }
    ...
    public void hierarchyChanged(HierarchyEvent e) {
      ...
      if (e.getID() == HierarchyEvent.HIERARCHY_CHANGED
          ...
          System.err.println(getParent().toString());
