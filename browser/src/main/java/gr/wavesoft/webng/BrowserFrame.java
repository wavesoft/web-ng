...
import gr.wavesoft.webng.ui.system.SystemViews;
...
import gr.wavesoft.webng.ui.PresenterEventListener;
import gr.wavesoft.webng.ui.PresenterThread;
import gr.wavesoft.webng.ui.SmoothButton;
...
public class BrowserFrame extends javax.swing.JPanel implements BrowserWindow, PresenterEventListener, PublicKeyEventListener {
    ...
    private void initComponents() {
        ...
        jMenuNewWindow = new javax.swing.JMenuItem();
        jSeparator1 = new javax.swing.JPopupMenu.Separator();
        jMenuSettings = new javax.swing.JMenu();
        jMenuConsole = new javax.swing.JMenuItem();
        jMenuCertificates = new javax.swing.JMenuItem();
        ...
        jMenuNewTab.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.META_MASK));
        jMenuNewTab.setText("New tab");
        jMenuNewTab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuNewTabActionPerformed(evt);
            }
        });
        jPopupMenu.add(jMenuNewTab);

        jMenuNewWindow.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.META_MASK));
        jMenuNewWindow.setText("New window");
        jPopupMenu.add(jMenuNewWindow);
        jPopupMenu.add(jSeparator1);

        jMenuSettings.setText("Settings");

        jMenuConsole.setText("Console");
        jMenuConsole.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuConsoleActionPerformed(evt);
            }
        });
        jMenuSettings.add(jMenuConsole);

        jMenuCertificates.setText("Certificates");
        jMenuCertificates.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuCertificatesActionPerformed(evt);
            }
        });
        jMenuSettings.add(jMenuCertificates);

        jPopupMenu.add(jMenuSettings);
        ...
        sbTools.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                sbToolsMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                sbToolsMouseReleased(evt);
            }
        });
    ...
    private void sbToolsMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sbToolsMouseReleased
        
    }//GEN-LAST:event_sbToolsMouseReleased

    private void jMenuConsoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuConsoleActionPerformed
        navigateTo("webng:console");
    }//GEN-LAST:event_jMenuConsoleActionPerformed

    private void jMenuCertificatesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuCertificatesActionPerformed
        navigateTo("webng:certificates");
    }//GEN-LAST:event_jMenuCertificatesActionPerformed

    private void sbToolsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sbToolsMousePressed
        
        jPopupMenu.show(sbTools, 0, sbTools.getHeight());
        jPopupMenu.requestFocus();

    }//GEN-LAST:event_sbToolsMousePressed
    ...
    private javax.swing.JMenuItem jMenuCertificates;
    private javax.swing.JMenuItem jMenuConsole;
    private javax.swing.JMenuItem jMenuNewTab;
    private javax.swing.JMenuItem jMenuNewWindow;
